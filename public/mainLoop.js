...
function startGame() {
    ...
    background = new button(0, 0, worldWidth * titleWidth, worldHeight * titleWidth,backgroundImg);

    gameoverScreen = new button (0, 0, worldWidth * titleWidth, worldHeight * worldHeight, gameoverImg);
    upgradeDmg = new button (300, worldHeight * titleHeigth, 100, 100, UTD);
    upgradeRange = new button (400, worldHeight * titleHeigth, 100, 100, UTR);
    tower1 = new button(100, worldHeight * titleHeigth, 100, 100, DTP);
    tower2 = new button(200, worldHeight * titleHeigth, 100, 100, WTP);
}
var gameArea = {
...
function mainLoop(){
    ...
    if (wolfSpawnTime <= 0 && wolfCount > 0){
        ...
        wolfSpawnTime = spawnTimeSelector(spawnWindow * 0.8);
        wolfCount--;
    }
