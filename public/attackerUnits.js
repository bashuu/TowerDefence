...
function addWolf(){
    enemy.push(new enemyForm(spawnLocX, spawnLocY, enemyHealth * 0.5, speed * 1.7));
    xDir.push(speed * 1.7);
    yDir.push(0)
...
function addBoss(){
    bossInd.push(enemy.length);
    enemy.push(new enemyForm(spawnLocX, spawnLocY, enemyHealth * 100, speed * 0.3));
    xDir.push(speed * 0.3);
    yDir.push(0);
    enemySprites.push(new SpriteSheet(bossSprite, 85, 55, 9, 8, 4, 0));
}
